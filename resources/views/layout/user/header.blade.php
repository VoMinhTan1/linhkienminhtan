        ...
        <div class="container-fluid fixed-top " style="margin-top: 58px; z-index: -1; position: absolute;">
          ...
          <nav class="navbar hr  ">
            <a class="nav-link" href="{{ route('gioithieu') }}" ><i class="far fa-hand-point-right"></i>   Giới thiệu</a>
               ...
               <div class="dropdown-content">
                <a class="dropdown-item" href="https://www.messenger.com/t/tan.vo.18400">Chat với tư vấn mua hàng</a>
                <h6 class="dropdown-item" href="">CSKH: <a href="" class="btn-outline-info">+84342392696</a>  <i class="fas fa-angle-right"></i> </h6>
