...
CREATE TABLE `banner` (
  ...
  `slide1` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ads` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `bills` (
  ...
  `status` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Chưa xử lí',
  `payment` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `codevnpay` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(6, 'tan', 'sản phẩm tốt', 20, 2, '2021-01-18 11:16:18', '2021-01-18 11:16:18');
...
CREATE TABLE `productdetails` (
  ...
  `guarantee` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
(3, 1, 'tan', 'tôi cũng vậy', 2, '2021-01-18 11:17:02', '2021-01-18 11:17:02'),
(4, 3, 'tan', 'ola', 2, '2021-01-18 11:48:13', '2021-01-18 11:48:13');
...
CREATE TABLE `users` (
  ...
  `typeuser` varchar(255) COLLATE utf8_unicode_ci DEFAULT 'user',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(2, 'Minh Tấn', 'votan100@gmail.com', NULL, '$2y$10$MNF4H9AlUpmjl2rmCcMn.O3ZvwbpScxY9Pj4LJYFpRLUApMl8N3fm', NULL, 'user', NULL, '2020-12-19 17:47:11'),
(5, 'Cao Phong', 'phongbanha@gmail.com', NULL, '$2y$10$FR7LihhkCMEchaC2kd1vgu7VBM1q.Za/OvgzibhGCd2ZXqYqOqZ7G', NULL, 'user', '2020-12-26 14:48:24', '2020-12-26 14:48:24'),
(7, 'Đức Quý', 'quyzzz@@gmail.com', NULL, '$2y$10$U3inBlRKheRlXW20XT6d1eFOZbPiyLJYRHQGjhj9EjYIZ5CrTLGPe', NULL, 'user', '2021-01-18 15:54:30', '2021-01-18 15:54:30');
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `v_category`  AS  select count(`categories`.`categoryID`) AS `countcate` from `categories` ;
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `v_quantity`  AS  select `categories`.`categoryName` AS `categoryName`,count(`products`.`productID`) AS `quantity` from (`categories` join `products` on(`products`.`categoryID` = `categories`.`categoryID`)) group by `categories`.`categoryName` ;
